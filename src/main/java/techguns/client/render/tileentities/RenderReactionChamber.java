...
public class RenderReactionChamber extends TileEntitySpecialRenderer<ReactionChamberTileEntMaster>{
		...
		if(te.isFormed()) {
			...
			//Render Fluid
				...
				if (liquid!=null){
					...
					//System.out.println("Alpha:"+ GL11.glGetBoolean(3008));
					//System.out.println("BlendState:"+ GL11.glGetBoolean(3042));
    ...
    {   
        ...
        buffer.pos((double)(x + 0), (double)(y + h), (double)z+w_z).tex((double)icon.getMinU(), (double)icon.getInterpolatedV(interp_v)).color(red, green, blue, alpha).endVertex();
        buffer.pos((double)(x + w_x), (double)(y + h), (double)z).tex((double)icon.getMaxU(), (double)icon.getInterpolatedV(interp_v)).color(red, green, blue, alpha).endVertex();
        buffer.pos((double)(x + w_x), (double)(y + 0), (double)z).tex((double)icon.getMaxU(), (double)icon.getMinV()).color(red, green, blue, alpha).endVertex();
        buffer.pos((double)(x + 0), (double)(y + 0), (double)z+w_z).tex((double)icon.getMinU(), (double)icon.getMinV()).color(red, green, blue, alpha).endVertex();
    }
}

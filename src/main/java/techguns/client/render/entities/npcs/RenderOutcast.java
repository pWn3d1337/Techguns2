...
public class RenderOutcast extends RenderGenericNPC<Outcast> {
	...
	public RenderOutcast(RenderManager renderManagerIn) {
	   ...
	   @Override
	protected ResourceLocation getEntityTexture(Outcast entity) {
		return TEXTURE;
	}

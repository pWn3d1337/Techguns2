...
public class TGuns implements ITGInitializer {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		handcannon = new GenericGun("handcannon", new StoneBulletProjectile.Factory(), AmmoTypes.STONE_BULLETS, true, 12,1,30, 8.0f, TGSounds.HANDGUN_FIRE, TGSounds.HANDGUN_RELOAD,25,0.035f).setBulletSpeed(0.9f).setGravity(0.015d).setDamageDrop(10, 25, 5.0f).setAIStats(RANGE_CLOSE, 60, 0, 0).setTexture("textures/guns/handgun").setRecoiltime(12);//.setMuzzleParticle(2,0.2f);
		 ...
		 boltaction = new GenericGun("boltaction", GENERIC_BULLET,AmmoTypes.RIFLE_ROUNDS, true, 25, 6, 50, 16.0f, TGSounds.BOLT_ACTION_FIRE, TGSounds.BOLT_ACTION_RELOAD,40,0.05f).setZoom(0.35f, true,0.125f,true).setBulletSpeed(2.5f).setRecoiltime(15).setRechamberSound(TGSounds.BOLT_ACTION_RECHAMBER).setDamageDrop(20, 30, 10.0f).setPenetration(0.15f).setAIStats(RANGE_FAR, 60, 0, 0).setTextures("textures/guns/boltactionrifle",3);//.setMuzzleParticle(1,0,0.05f,0.3f);
		 ...
		 biogun = new GenericGunCharge("biogun", new BioGunProjectile.Factory(), AmmoTypes.BIO_TANK, false, 6, 30,45,10.0f, TGSounds.BIOGUN_FIRE, TGSounds.BIOGUN_RELOAD, 35, 0.015f,30.0f,3).setBulletSpeed(0.75f).setGravity(0.01d).setPenetration(0.15f).setTexture("textures/guns/BioGun").setAIStats(RANGE_SHORT, 30, 0, 0).setDamageDrop(8, 15, 8.0f);
		   		 
		 rocketlauncher = new GenericGun("rocketlauncher", new RocketProjectile.Factory(), AmmoTypes.ROCKETS, true, 10, 1 , 40, 50.0f, TGSounds.ROCKET_FIRE, TGSounds.ROCKET_RELOAD, 100, 0.05f).setGravity(0.01D).setBulletSpeed(1.0f).setRecoiltime(10).setAIStats(RANGE_MEDIUM,80,0,0).setTexture("textures/guns/rocketlauncher");/*.setTurretPosOffset(0f, -0.7f, -0.2f);*/
		   	
		 minigun = new GenericGun("minigun",GENERIC_BULLET,AmmoTypes.MINIGUN_AMMO_DRUM,false, 0, 200, 100, 5.0f, TGSounds.MINIGUN_FIRE, TGSounds.MINIGUN_RELOAD, 50, 0.025f).setDamageDrop(20, 40, 3.0f).setPenetration(0.15f).setAIStats(RANGE_MEDIUM, 40, 10, 1).setTexture("textures/guns/minigun")/*.setHandType(GunHandType.ONE_HANDED)*//*.setTurretPosOffset(0, 0.20f, 0)*/.setCheckRecoil().setMuzzleFlashTime(4).setCheckMuzzleFlash();//.setRecoiltime(30).setFiresoundStart("techguns:guns.minigunStart").setMaxLoopDelay(10)
			
		 combatshotgun = new GenericGun("combatshotgun",GENERIC_BULLET, AmmoTypes.SHOTGUN_ROUNDS, true, 14, 8, 50, 4.0f, TGSounds.COMBATSHOTGUN_FIRE, TGSounds.COMBATSHOTGUN_RELOAD,15, 0.01f).setAmmoCount(8).setShotgunSpread(7,0.15f,false).setRecoiltime(12).setRechamberSound(TGSounds.COMBATSHOTGUN_RECHAMBER).setDamageDrop(2, 5, 1.5f).setPenetration(0.15f).setAIStats(RANGE_CLOSE,30,0,0).setTexture("textures/guns/combatShotgun")/*.setTurretPosOffset(0, 0.075f, 0).setMuzzleParticle(2,0.1f);*/;
		   
		 grimreaper = new GenericGun("grimreaper", new RocketProjectile.Factory(), AmmoTypes.ROCKETS, false, 6, 4 , 40, 50.0f, TGSounds.ROCKET_FIRE, TGSounds.ROCKET_RELOAD, 100, 0.05f).setGravity(0.01D).setBulletSpeed(1.0f).setRecoiltime(10).setAmmoCount(4).setAIStats(RANGE_MEDIUM, 120, 4, 30).setTexture("textures/guns/grimreaper");//.setTurretPosOffset(0f, -0.7f, -0.4f);
		 ...
		 pulserifle = new GenericGun("pulserifle",new AdvancedBulletProjectile.Factory(), AmmoTypes.ASSAULT_RIFLE_MAGAZINE, false, 7, 12, 45, 10.0f,  TGSounds.PULSE_RIFLE_FIRE, TGSounds.PULSE_RIFEL_RELOAD, 50,0.024f).setDamageDrop(25, 35, 8f).setZoom(0.35f, true,0.5f,true).setBulletSpeed(2.25f).setRecoiltime(8).setPenetration(0.25f).setShotgunSpread(2, 0.015f,true).setAIStats(RANGE_MEDIUM, 30, 0, 0).setTextures("textures/guns/pulserifle",3).setMuzzleFlashTime(4);
		 
	 	 lasergun = new GenericGun("lasergun", new LaserProjectile.Factory(), AmmoTypes.ENERGY_CELL, false, 5, 45, 45, 12.0f, TGSounds.LASERGUN_FIRE, TGSounds.LASERGUN_RELOAD, 20, 0.0f).setZoom(0.75f, true,0.75f,false).setBulletSpeed(100.0f).setAIStats(RANGE_MEDIUM, 30, 0, 0).setTexture("textures/guns/lasergun"); //.setTexture("textures/guns/laserGunNew");//
	 	 
	 	 alienblaster = new GenericGun("alienblaster", GENERIC_BULLET, AmmoTypes.ENERGY_CELL, false, 8, 10, 35, 16.0f, TGSounds.ALIENBLASTER_FIRE, TGSounds.ALIENBLASTER_RELOAD, 50, 0.0f).setMuzzleFlashTime(10).setPenetration(0.2f).setAIStats(RANGE_MEDIUM, 40, 0, 0).setTexture("textures/guns/alien_blaster").setHandType(GunHandType.ONE_HANDED);
		 
	 	 netherblaster = new GenericGun("netherblaster", GENERIC_BULLET, AmmoTypes.NETHER_CHARGE, false, 8, 10, 35, 14.0f, TGSounds.NETHERBLASTER_FIRE, TGSounds.NETHERBLASTER_RELOAD, 50, 0.0f).setMuzzleFlashTime(10).setPenetration(0.15f).setAIStats(RANGE_MEDIUM, 40, 0, 0).setTexture("textures/guns/cyberdemonblaster").setDamageDrop(15, 30, 8.0f).setHandType(GunHandType.ONE_POINT_FIVE_HANDED);
		 ...
		 powerhammer = new GenericGunMeleeCharge("powerhammer", new BioGunProjectile.Factory(), AmmoTypes.COMPRESSED_AIR_TANK, false, 4, 20, 45, 2.5f, TGSounds.POWERHAMMER_FIRE, TGSounds.POWERHAMMER_RELOAD,10,0.0f,30f,10).setMeleeDmg(6.0f, 2.0f).setTool("pickaxe", 2).setTool("shovel", 2).setDigSpeed(12.0f).setTexture("textures/guns/powerHammer").setRecoiltime(12).setShootWithLeftClick(false).setAIStats(RANGE_MELEE, 30, 0, 0).setDamageDrop(3, 3, 2.5f).setHandType(GunHandType.ONE_HANDED);
		 ...
		 sonicshotgun = new GenericGun("sonicshotgun",GENERIC_BULLET, AmmoTypes.ENERGY_CELL,true, 12, 8, 40, 25.0f, TGSounds.SONIC_SHOTGUN_FIRE, TGSounds.SONIC_SHOTGUN_RELOAD,20,0.0f).setDamageDrop(5, 15, 5.0f).setPenetration(0.25f).setAIStats(RANGE_SHORT, 40, 0, 0).setTexture("textures/guns/sonicshotgun");
		 chainsaw = new GenericGunMeleeCharge("chainsaw", new BioGunProjectile.Factory(), AmmoTypes.FUEL_TANK, false, 3, 300, 45, 10.0f, TGSounds.CHAINSAW_LOOP, TGSounds.POWERHAMMER_RELOAD, 2, 0.0f,1f,1).setMeleeDmg(12.0f, 2.0f).setTool("axe", 3).setDigSpeed(14.0f).setTexture("textures/guns/chainsaw").setRecoiltime(5).setShootWithLeftClick(false).setFiresoundStart(TGSounds.CHAINSAW_LOOP_START).setMaxLoopDelay(10).setPenetration(0.25f).setAIStats(RANGE_MELEE, 10, 0, 0); //.setTurretPosOffset(0, 0.50f, 0);
		 scatterbeamrifle = new GenericGun("scatterbeamrifle", BLASTER_PROJECTILE, AmmoTypes.ENERGY_CELL, false, 7, 40, 45, 6.0f, TGSounds.LASERGUN_FIRE, TGSounds.LASERGUN_RELOAD, 30/*TODO?Lasergun.LIFETIME*/, 0.1f).setShotgunSpread(4,0.15f,false).setZoom(0.75f, true,0.75f,false).setBulletSpeed(2.0f).setAIStats(RANGE_SHORT, 30, 0, 0).setTexture("textures/guns/lasergunnew");

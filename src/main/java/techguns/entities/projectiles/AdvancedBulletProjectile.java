...
public class AdvancedBulletProjectile extends GenericProjectile{
	...
	public static class Factory implements IProjectileFactory<AdvancedBulletProjectile> {
		...
		@Override
		public AdvancedBulletProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage, float speed, int TTL, float spread, int dmgDropStart, int dmgDropEnd,

...
public class StoneBulletProjectile extends GenericProjectile {
	...
	public StoneBulletProjectile(World worldIn, double posX, double posY, double posZ, float yaw, float pitch, float damage, float speed, int TTL, float spread, int dmgDropStart,
	...
	public static class Factory implements IProjectileFactory<StoneBulletProjectile> {
		...
		@Override
		public StoneBulletProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage, float speed, int TTL, float spread, int dmgDropStart, int dmgDropEnd,
